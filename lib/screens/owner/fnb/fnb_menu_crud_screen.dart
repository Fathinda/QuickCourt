...
class _FnbMenuCrudScreenState extends State<FnbMenuCrudScreen> {
  ...
  Future<void> fetchCategories() async {
    try {
      ...
      final url = Uri.parse("http://192.168.1.22:8000/api/fnb-categories");
  ...
  Future<void> fetchMenus() async {
    ...
    try {
      ...
      final url = Uri.parse(
          "http://192.168.1.22:8000/api/owner/venues/${widget.venueId}/fnb-menus");
      final response = await http.get(url, headers: {
        "Authorization": "Bearer $token",
      });
  ...
  Future<void> deleteMenu(int menuId) async {
    try {
      ...
      final url =
          Uri.parse("http://192.168.1.22:8000/api/owner/fnb-menus/$menuId");
